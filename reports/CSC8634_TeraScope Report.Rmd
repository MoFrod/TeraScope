...
Newcastle University's supercomputer architecture for scalable visualisation allows the institution to produce terapixel viusalisations that support daily updates and undertaking rigorous evaluation (@TeraScope). This project uses a dataset created from the production of a terapixel image by this architecture, and aims to provide useful insights into the computation performance. Understanding this is important as there is significant computational cost (resource, power, environmental and monetary) to producing a high quality terapixel image (@Terapixel). The visualisation output can be seen [here](http://terapixel.wasabi.1024.s3.eu-central-1.wasabisys.com/vtour/index.html).
